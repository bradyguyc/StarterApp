    ...
    public class MSALClientHelper
    {
        ...
        private void InitializePublicClientApplicationBuilder()
        {
            this.PublicClientApplicationBuilder = PublicClientApplicationBuilder.Create(AzureAdConfig.ClientId)
               ...
               .WithLogging(new IdentityLogger(EventLogLevel.LogAlways), enablePiiLogging: true)    // This is the currently recommended way to log MSAL message. For more info refer to https://github.com/AzureAD/microsoft-authentication-library-for-dotnet/wiki/logging. Set Identity Logging level to Warning which is a middle ground
        ...
        public async Task<string> SignInUserAndAcquireAccessToken(string[] scopes)
        {
            ...
            {
                Debug.WriteLine($"Error Acquiring Token interactively:{Environment.NewLine}{msalEx}{Environment.NewLine}{msalEx.ToJsonString}");
                throw new Exception(msalEx.ToString());
            }
